...
```javascript
import add from 'https://cdn.jsdelivr.net/gh/stdlib-js/number-uint16-base-add@v0.1.0-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/number-uint16-base-add/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/number-uint16-base-add/actions/workflows/test.yml?query=branch:v0.1.0
